  ...
  render() {
    ...
    return (
      <View style={{ justifyContent: 'center', height: '100%' }}>
        <TouchableOpacity style={{ position: 'absolute', left: 20, top: 35 }} onPress={() => this.props.navigation.goBack()}>
            <FontAwesome size={36} name="close" color="#000"/>
        </TouchableOpacity>
        {cuecards.length > 0 && (
          <View>
            <SwiperFlatList
